 ...
 */
package com.javen.orm.inner.converter;

import static com.javen.orm.inner.ReflectionUtils.newInstance;
...
import com.javen.orm.inner.TypeHelper;
import com.javen.orm.model.Model;
import com.javen.orm.persist.json.JSONSerializer;
import com.javen.orm.util.Arrays2;
import com.javen.orm.util.Strings;
...
public class ArrayCollectionConverter extends Converter<Object> {
	...
	protected <V> Object parseFromString(Class<Object> valType,
		...
		boolean isArr = TypeHelper.isArray(valType);
		Object[] arr = null;
