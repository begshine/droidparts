...
import static com.javen.orm.inner.ReflectionUtils.getFieldVal;
...
public abstract class Model implements Serializable {
	...
	public String toString() {
		...
		for (FieldSpec<KeyAnn> spec : ClassSpecRegistry.getJsonKeySpecs(getClass())) {
			fields.add(spec.field);
		}
		if (this instanceof Entity) {
			for (FieldSpec<ColumnAnn> spec : ClassSpecRegistry.getTableColumnSpecs((Class<? extends Entity>) getClass())) {
				fields.add(spec.field);
			}
		}
